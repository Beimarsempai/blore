       ...
       /*case 'ownergrup':
		...
		if (budy.includes(`fua`)) {
				  ...
				  if (budy.startsWith(`bot`)) {
					const none = fs.readFileSync('./imagenes/bot.jpeg');
					client.sendMessage(from, none, MessageType.audio, {quoted: mek, mimetype: 'image/jpeg', ptt:true})
							  }
				  if (budy.startsWith(`npack1`)) {
					const none = fs.readFileSync('./imagenes/R18 (1).jpeg');
					client.sendMessage(from, none, MessageType.image, {quoted: mek, mimetype: 'image/jpeg', ptt:true})
							  }		
				  if (budy.startsWith(`npack2`)) {
					const none = fs.readFileSync('./imagenes/R18 (2).jpeg');
					client.sendMessage(from, none, MessageType.image, {quoted: mek, mimetype: 'image/jpeg', ptt:true})
							  }			
				  if (budy.startsWith(`npack3`)) {
					const none = fs.readFileSync('./imagenes/R18 (4).jpeg');
					client.sendMessage(from, none, MessageType.image, {quoted: mek, mimetype: 'image/jpeg', ptt:true})
							  }			
				  if (budy.startsWith(`npack4`)) {
					const none = fs.readFileSync('./imagenes/R18 (5).jpeg');
					client.sendMessage(from, none, MessageType.image, {quoted: mek, mimetype: 'image/jpeg', ptt:true})
							  }			
				  if (budy.startsWith(`npack5`)) {
					const none = fs.readFileSync('./imagenes/R18 (6).jpeg');
					client.sendMessage(from, none, MessageType.image, {quoted: mek, mimetype: 'image/jpeg', ptt:true})
							  }			
				  if (budy.startsWith(`npack6`)) {
					const none = fs.readFileSync('./imagenes/R18 (7).jpeg');
					client.sendMessage(from, none, MessageType.image, {quoted: mek, mimetype: 'image/jpeg', ptt:true})
							  }			
				  if (budy.startsWith(`npack7`)) {
					const none = fs.readFileSync('./imagenes/R18 (8).jpeg');
					client.sendMessage(from, none, MessageType.image, {quoted: mek, mimetype: 'image/jpeg', ptt:true})
							  }			
				  if (budy.startsWith(`npack8`)) {
					const none = fs.readFileSync('./imagenes/R18 (9).jpeg');
					client.sendMessage(from, none, MessageType.image, {quoted: mek, mimetype: 'image/jpeg', ptt:true})
							  }			
				  if (budy.startsWith(`npack9`)) {
					const none = fs.readFileSync('./imagenes/R18 (10).jpeg');
					client.sendMessage(from, none, MessageType.image, {quoted: mek, mimetype: 'image/jpeg', ptt:true})
							  }			
				  if (budy.startsWith(`npack10`)) {
					const none = fs.readFileSync('./imagenes/R18 (11).jpeg');
					client.sendMessage(from, none, MessageType.image, {quoted: mek, mimetype: 'image/jpeg', ptt:true})
							  }			
				  if (budy.startsWith(`npack11`)) {
					const none = fs.readFileSync('./imagenes/R18 (12).jpeg');
					client.sendMessage(from, none, MessageType.image, {quoted: mek, mimetype: 'image/jpeg', ptt:true})
							  }			
				  if (budy.startsWith(`npack12`)) {
					const none = fs.readFileSync('./imagenes/R18 (13).jpeg');
					client.sendMessage(from, none, MessageType.image, {quoted: mek, mimetype: 'image/jpeg', ptt:true})
							  }			
				  if (budy.startsWith(`npack13`)) {
					const none = fs.readFileSync('./imagenes/R18 (14).jpeg');
					client.sendMessage(from, none, MessageType.image, {quoted: mek, mimetype: 'image/jpeg', ptt:true})
							  }			
				  if (budy.startsWith(`npack14`)) {
					const none = fs.readFileSync('./imagenes/R18 (15).jpeg');
					client.sendMessage(from, none, MessageType.image, {quoted: mek, mimetype: 'image/jpeg', ptt:true})
							  }			
				  if (budy.startsWith(`npack15`)) {
					const none = fs.readFileSync('./imagenes/R18 (16).jpeg');
					client.sendMessage(from, none, MessageType.image, {quoted: mek, mimetype: 'image/jpeg', ptt:true})
							  }			
				  if (budy.startsWith(`npack16`)) {
					const none = fs.readFileSync('./imagenes/R18 (17).jpeg');
					client.sendMessage(from, none, MessageType.image, {quoted: mek, mimetype: 'image/jpeg', ptt:true})
							  }			
				  if (budy.startsWith(`npack17`)) {
					const none = fs.readFileSync('./imagenes/R18 (18).jpeg');
					client.sendMessage(from, none, MessageType.image, {quoted: mek, mimetype: 'image/jpeg', ptt:true})
							  }			
				  if (budy.startsWith(`npack18`)) {
					const none = fs.readFileSync('./imagenes/R18 (19).jpeg');
					client.sendMessage(from, none, MessageType.image, {quoted: mek, mimetype: 'image/jpeg', ptt:true})
							  }			
				  if (budy.startsWith(`npack19`)) {
					const none = fs.readFileSync('./imagenes/R18 (20).jpeg');
					client.sendMessage(from, none, MessageType.image, {quoted: mek, mimetype: 'image/jpeg', ptt:true})
							  }			
				  ...
				  if (budy.startsWith(`npack21`)) {
					const none = fs.readFileSync('./imagenes/R18 (22).jpeg');
					client.sendMessage(from, none, MessageType.image, {quoted: mek, mimetype: 'image/jpeg', ptt:true})
							  }			
				  if (budy.startsWith(`npack22`)) {
					const none = fs.readFileSync('./imagenes/R18 (23).jpeg');
					client.sendMessage(from, none, MessageType.image, {quoted: mek, mimetype: 'image/jpeg', ptt:true})
							  }			
				  if (budy.startsWith(`npack23`)) {
					const none = fs.readFileSync('./imagenes/R18 (24).jpeg');
					client.sendMessage(from, none, MessageType.image, {quoted: mek, mimetype: 'image/jpeg', ptt:true})
							  }			
					  if (budy.startsWith(`npack24`)) {
					const none = fs.readFileSync('./imagenes/R18 (25).jpeg');
					client.sendMessage(from, none, MessageType.image, {quoted: mek, mimetype: 'image/jpeg', ptt:true})
							  }			
				  if (budy.startsWith(`npack25`)) {
					const none = fs.readFileSync('./imagenes/R18 (26).jpeg');
					client.sendMessage(from, none, MessageType.image, {quoted: mek, mimetype: 'image/jpeg', ptt:true})
							  }			
				  if (budy.startsWith(`npack26`)) {
					const none = fs.readFileSync('./imagenes/R18 (27).jpeg');
					client.sendMessage(from, none, MessageType.image, {quoted: mek, mimetype: 'image/jpeg', ptt:true})
							  }		
				  if (budy.startsWith(`npack27`)) {
					const none = fs.readFileSync('./imagenes/R18 (28).jpeg');
					client.sendMessage(from, none, MessageType.image, {quoted: mek, mimetype: 'image/jpeg', ptt:true})
							  }	
				  if (budy.startsWith(`npack28`)) {
					const none = fs.readFileSync('./imagenes/R18 (29).jpeg');
					client.sendMessage(from, none, MessageType.image, {quoted: mek, mimetype: 'image/jpeg', ptt:true})
							  }	
				  if (budy.startsWith(`npack29`)) {
					const none = fs.readFileSync('./imagenes/R18 (30).jpeg');
					client.sendMessage(from, none, MessageType.image, {quoted: mek, mimetype: 'image/jpeg', ptt:true})
							  }	
				  if (budy.startsWith(`npack30`)) {
					const none = fs.readFileSync('./imagenes/R18 (31).jpeg');
					client.sendMessage(from, none, MessageType.image, {quoted: mek, mimetype: 'image/jpeg', ptt:true})
							  }								  							  							  							  								  							  							  						  							  							  							  							  							  							  							  							  							  							  							  							  							  							  							  							  							  							  							  							  							  				  					  
